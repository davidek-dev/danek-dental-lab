/* empty css                                  */import { e as createAstro, f as createComponent, r as renderTemplate, h as addAttribute, i as renderHead, j as renderSlot, m as maybeRenderHead, k as renderComponent, u as unescapeHTML } from '../astro_70af7458.mjs';
import 'clsx';
/* empty css                                  */import contentful from 'contentful';
import { documentToHtmlString } from '@contentful/rich-text-html-renderer';

const $$Astro$6 = createAstro("https://danekdentallab.netlify.app");
...
const $$Astro$5 = createAstro("https://danekdentallab.netlify.app");
...
const $$Astro$4 = createAstro("https://danekdentallab.netlify.app");
...
const $$Astro$3 = createAstro("https://danekdentallab.netlify.app");
...
const $$Astro$2 = createAstro("https://danekdentallab.netlify.app");
...
const $$Astro$1 = createAstro("https://danekdentallab.netlify.app");
...
const $$Astro = createAstro("https://danekdentallab.netlify.app");
const $$LandingPage = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$LandingPage;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to Astro." }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, {})} ${renderComponent($$result2, "HeroSection", $$HeroSection, {})} ${renderComponent($$result2, "BlogPreview", $$BlogPreview, {})} ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
}, "C:/Users/david/Documents/GitHub/my-portfolio/src/pages/landing page.astro", void 0);

const $$file = "C:/Users/david/Documents/GitHub/my-portfolio/src/pages/landing page.astro";
const $$url = "/landing page";

const landing_page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$LandingPage,
  file: $$file,
  url: $$url
...
export { $$Header as $, $$Footer as a, contentfulClient as c, landing_page as l };
